-- ════════════════════════════════════════════════════════════════════════════
-- « Frontières » (borders) — server-side enablement.
-- Widens matches.game_mode CHECK (supersedes silhouette.sql) and the
...
-- complete_daily / award_solo_coins re-deployed with 'borders' added to their
-- IN (...) whitelists — see daily.sql / economy.sql for the bodies.
