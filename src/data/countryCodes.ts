/**
 * Maps ISO 3166-1 alpha-3 country codes (cca3) to alpha-2 codes (cca2).
 * Used to build flag URLs from the alpha-3 codes stored in the game data.
 */
export const CCA3_TO_CCA2: Record<string, string> = {
