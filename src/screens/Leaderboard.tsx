...
const SOLO_MODES: ModeDef[] = [
  ...
  { key: 'pinpoint', fr: 'Point sur le Globe', en: 'Pin on the Globe', icon: MapPin, accent: (d) => (d ? PALETTE.chartBlue : PALETTE.vermilion), unit: pts },
  { key: 'languages', fr: 'Langues', en: 'Languages', icon: Languages, accent: (d) => (d ? PALETTE.chartBlue : PALETTE.oceanBlue), unit: pts },
...
const ONLINE_MODES: ModeDef[] = [
  ...
  { key: 'pinpoint', fr: 'Point sur le Globe', en: 'Pin on the Globe', icon: MapPin, accent: (d) => (d ? PALETTE.chartBlue : PALETTE.vermilion), unit: pct },
  { key: 'languages', fr: 'Langues', en: 'Languages', icon: Languages, accent: (d) => (d ? PALETTE.chartBlue : PALETTE.oceanBlue), unit: pct },
